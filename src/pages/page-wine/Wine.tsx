                        ...
                        <div className={wineStyle.wineDetails}>
                            ...
                            <div className={wineStyle.wineInfo}>
                                <div className={wineStyle.wineName}>
                                    ...
                                    {wine.wineInfo && wine.wineInfo[0] && (
                                        <p 
                                            className={wineStyle.nameKR} 
                                            style={{ color: wine.wineInfo[0].wineType }
                                        }>{wine.name}({wine.wineInfo[0].wineType} wine)</p>
                                    )}
                                </div>
                                <p className={wineStyle.price}>{formatNumber(wine.price)}원</p>
                            </div>
                            {wine.wineInfo && wine.wineInfo[0] && (
